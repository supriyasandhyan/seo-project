      ...
      <div className={classes["policy"]} id="policyid">
        <div className={classes["aa"]}>
          ...
          <div className={classes["poli-cc"]}>
            <h1 className={classes["policc-h1"]}>
              Our Pricing Policy
              <span className={classes["spanpoli-h1"]}>
                <br />
                THAT ENSURES CLARITY
              </span>
            </h1>
            {clicking1 && (
              <p className={classes["policc-para"]}>
                Hire SEO or Outsource SEO services from Nimap Infotech that
                helps your brand makes its presence in the online market. Race
                through the competition and get the results that speak for
                itself You can hire our SEO Experts for your workplace on a
                timely basis according to your Digital Marketing Requirements
              </p>
            )}
            {clicking2 && (
              <p className={classes["claritypara"]}>
                We provide.
                <br />
                If you have visualized the needs for your digital
                <br />
                marketing activities and want to implement it <br />
                then go for our fixed price model Our DM experts will assist you
                on a<br />
                one-on-one basis.
                <br />
            ...
            {clicking2 && (
              <div>
                <p className={classes["claritypara2"]}>
                  We are versatile enough to settle the way of working and
                  payment methods, we can divide it on a
                  <br />
                  monthly basis instead of doing all payment at the single go.
                  <br />
                  <br />
        ...
        <div className={classes["mainpolibtn"]}>
          <button onClick={polcy} className={classes[colorclass1]}>
            HIRE AN EXPERT
          </button>

          <button onClick={clrity} className={classes[colorclass2]}>
            FIXED PRICE WORK
          </button>
        </div>
      </div>
